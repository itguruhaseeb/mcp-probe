...
% TODO(owner): replace with a peer-reviewed reference on LLM tool-use reliability
% before submission (e.g. a tool-use / agent-reliability benchmark paper).
Placeholder reference.
\newblock \emph{Tool-use reliability in large language model agents}.
\newblock 2025.
